"""
LieuPredictor / 调休预测器 - 基于 Python 的调休预测。

Copyright (C) 2024

原作 azaz-az。本作 NebuDr1ft。
...
if __name__ == "__main__":
    print("LieuPredictor / 调休预测器 - 基于 Python 的调休预测")
    print("键入 help 以查看帮助。")
    ...
    while True:
        ...
        try:  # 这段代码判定是否让程序进入调试模式。调试模式默认处于关闭状态。
            ...
            print("\nLieuPredictor / 调休预测器 已结束运行。感谢你的使用。\n")
            break
        ...
        if input_list[0] in ("forecast", "fc"):  # 处理用户发起的 forecast 指令请求。
            try:
                ...
                print(
                    "如果无法定位程序未按预期运行的原因，请向我们报告错误。https://github.com/NebuDr1ft/LieuPredictor\n"
                )
